...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        print("Switch Feature: ",datapath.id)
    ...
    def send_role_request(self, datapath):
        ...
        ofp.OFPCR_ROLE_EQUAL
        ofp.OFPCR_ROLE_NOCHANGE
        '''
        
        req = ofp_parser.OFPRoleRequest(datapath, ofp.OFPCR_ROLE_MASTER, 0)
        print("Role Request to MASTER")
    ...
    def role_reply_handler(self, ev):
        ...
        if msg.role == ofp.OFPCR_ROLE_NOCHANGE:
            ...
            role = 'EQUAL'
            print("Changed to EQUAL")
        elif msg.role == ofp.OFPCR_ROLE_MASTER:
            role = 'MASTER'
            print("Changed to MASTER")
        elif msg.role == ofp.OFPCR_ROLE_SLAVE:
            role = 'SLAVE'
            print("Changed to SLAVE")
        else:
            role = 'unknown'
